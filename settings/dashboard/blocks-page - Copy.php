                 ...
                 //   var_dump($headerDesigns);
                    ...
                    <?php foreach($headerDesigns as $headerDesign):?>
                        <li id="item-<?php echo $headerDesign['post_id'];?>" class="row-header installed list-group-item">
                             ...
                             // echo $headerDesign['block_name'];
                             
                             ?>
                             <img src="<?php echo  $headerDesign['thumbnail'];?>">
                             
                             <span class="btn-group-right">
                                    <a target="_blank" class="btn btn-primary btn-sm" href="<?php echo  $headerDesign['thumbnail'];?>"> <i class="fas fa-eye"></i> Preview </a>
                                    <a data-slug="<?php echo $headerDesign['block_slug'];?>" data-file="<?php echo $headerDesign['json_file'];?>" class="btn btn-danger deleteItem btn-sm" data-postid="<?php echo $headerDesign['post_id'];?>" data-id="<?php echo $headerDesign['id'];?>" href="javascript:;"><i class="fas fa-trash-alt"></i> Remove</a>
                            </span>
